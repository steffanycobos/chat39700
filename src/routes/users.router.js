...
import {currentUserController,deleteUserController,getUserDataController,uploadDocumentsController} from "../controllers/users.controller.js";
...
usersRouter.get('/', getUserDataController)
